...
@section('content')
        ...
        <div id="dialog"
            ...
            <h1 class="text-2xl font-semibold text-blue-500">ADD AGENT PROFILE</h1>
            <div class="w-full">
                ...
                <div class="flex justify-end mt-6">
                    ...
                    <button id="save" class="px-5 py-2 bg-indigo-500 hover:bg-indigo-600 text-white cursor-pointer rounded-md">
                        Save Changes
                    </button>
                </div>
                </form>
