        ...
        <div class="mb-3 flex justify-between">
            <label>@yield('title')</label>
                        ...
                        <div class="mt-6 mb-3 flex items-center justify-center">
                            <button class="w-40 py-3 px-4  text-center bg-indigo-600 rounded-md text-white text-sm hover:bg-indigo-500" data-bs-toggle="modal" data-bs-target="#addCollector"><i class="fa fa-plus"></i> Add Collector</button>
                        </div>
