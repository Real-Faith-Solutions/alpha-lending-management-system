...
@section('content')
   ...
   <div id="dialog" class="hidden fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-11/12 sm:w-3/5 md:w-1/2 lg:w-1/3 bg-white rounded-md px-4 sm:px-8 py-6 space-y-5 sm:space-y-6 drop-shadow-lg">
       <h1 class="text-2xl font-semibold text-blue-500 text-center">ADD COLLECTOR PROFILE</h1>
       <div class="w-full">
           <form class="bg-white shadow-md rounded px-4 sm:px-8 pt-6 pb-8 mb-4">
               ...
               <div class="mb-4">
                ...
                <label class="block text-sm font-bold mb-2" for="username">
                    Designated Area
                    <input class="shadow appearance-none border rounded w-full sm:w-4/5 mt-2 sm:ml-14 py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" name="designated_area" id="designated_area" placeholder="Caloocan City" required>
                </label>
                </div>
    ...
    <h1 class="bold text-2xl text-blue-800 ml-6 mb-6">Payments Schedule</h1>
