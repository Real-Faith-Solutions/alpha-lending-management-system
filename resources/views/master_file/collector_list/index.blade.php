...
@section('content')
     ...
     <div id="dialog" class="hidden fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-11/12 sm:w-3/5 md:w-1/2 lg:w-1/3 bg-white rounded-md px-4 sm:px-8 py-6 space-y-5 sm:space-y-6 drop-shadow-lg">
         <h1 class="text-2xl font-semibold text-blue-500 text-center">ADD COLLECTOR</h1>
         <div class="w-full">
        ...
        <h1 class="bold text-2xl text-blue-800 ml-6 mb-6">COLLECTOR LIST</h1>
                ...
                <label>@yield('title')</label>
                    ...
                    @include('components.input')
                     ...
                     <div class="mt-6 mb-3 flex items-center justify-end">
                        <button class="w-40 py-3 px-4  text-center bg-indigo-600 rounded-md text-white text-sm hover:bg-indigo-500" data-bs-toggle="modal" data-bs-target="#addCollector" id="collector"> Add Collecttor</button>
                    </div>
